...
const AdjustmentPanel: React.FC<AdjustmentPanelProps> = ({ onApplyAdjustment, isLoading }) => {
  ...
  const presets = [
    ...
    { name: 'Cooler Tones', prompt: 'Adjust the color balance to give the image a cooler, more cinematic and blue-toned look.' },
    { name: 'High Contrast', prompt: 'Increase the contrast for a more dramatic, punchy look with deeper blacks and brighter whites.' },
    { name: 'Soft Focus', prompt: 'Apply a soft, dreamy focus effect across the entire image for a gentle, ethereal feel.' },
    { name: 'Vignette', prompt: 'Add a subtle, dark vignette around the edges of the image to draw focus to the center.' },
  ];
