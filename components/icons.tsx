...
export const LayersIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.115 5.19A7.5 7.5 0 0 1 12 3a7.5 7.5 0 0 1 5.885 2.19m-11.77 0a7.5 7.5 0 0 0-2.198 5.885c0 3.836 2.956 7.036 6.782 7.275M12 21a7.5 7.5 0 0 0 5.885-2.19m-11.77 0a7.5 7.5 0 0 1 2.198-5.885c3.826-.24 6.782-3.44 6.782-7.275M12 3v18" />
  </svg>
);
...
export const DocumentMagnifyingGlassIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 7.5H15.75c.621 0 1.125.504 1.125 1.125v1.125c0 .621-.504 1.125-1.125 1.125H13.5m-3-3.375v.625c0 .621.504 1.125 1.125 1.125H15m-3-3.375a1.125 1.125 0 0 1-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125H15.75c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125H13.5m0-3.375V6.375" />
  </svg>
);