...
const FilterPanel: React.FC<FilterPanelProps> = ({ onApplyFilter, isLoading }) => {
  ...
  const presets = [
    ...
    { name: 'Vintage Film', prompt: 'Give the image an authentic vintage film look, with faded colors, subtle grain, and light leaks.' },
    { name: 'Pop Art', prompt: 'Transform the photo into a bold, colorful Pop Art style inspired by Andy Warhol, using vibrant, contrasting colors and a screen-printed effect.' },
    { name: 'Watercolor', prompt: 'Convert the image into a beautiful watercolor painting with soft, blended colors and a textured paper effect.' },
    { name: 'Pixel Art', prompt: 'Recreate the image in a retro, 16-bit pixel art style with a limited color palette and blocky details.' },
  ];
